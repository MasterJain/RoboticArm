...
// int SavedPs1Axis = Initial position
int SavedPos1Axis = 90;
int axis1pos[] = {0};
...
void setup() {
  ...
  Axis1.attach(8); Axis2.attach(9); Axis3.attach(10); Axis4.attach(11); Axis5.attach(12); Axis6.attach(13); //Axises attaching to pins
  Back_to_Init_pos(); //Set robot to initial position
  Axis1Pos_saved[9] = {InitPosAxis1}; Axis2Pos_saved[9] = {InitPosAxis2}; Axis3Pos_saved[9] = {InitPosAxis3}; Axis4Pos_saved[9] = {InitPosAxis4}; Axis5Pos_saved[9] = {InitPosAxis5}; Axis6Pos_saved[9] = {InitPosAxis6};
}
...
void loop() {
  if (Serial.available() > 0) {
    ...
    data_from_Bluetooth = Serial.readString();
